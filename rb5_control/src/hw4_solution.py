...
pose_ma = {3: np.asarray([[0, 1, 0, 0.55],[-1, 0, 0, 0.015], [0, 0,  1, 0.15], [0,0,0,1]]),
2: np.asarray([[0, 1, 0, 1.55],[-1, 0, 0, 0.015], [0, 0, 1, 0.15], [0,0,0,1]]),
7: np.asarray([[0, 0, 1, 2.05],[-1, 0, 0, 0.515], [0, -1, 0, 0.15], [0,0,0,1]]),
8: np.asarray([[0, 0, 1, 2.05],[-1, 0, 0, 1.515], [0, -1, 0, 0.15], [0,0,0,1]]),
4: np.asarray([[1, 0, 0, 1.55],[0, 0, 1, 2.015], [0, -1, 0, 0.15], [0,0,0,1]]),
1: np.asarray([[1, 0, 0, 0.55], [0, 0, 1, 2.015], [0, -1, 0, 0.15], [0, 0, 0, 1]]),
5: np.asarray([[1, 0, 0, 0.97], [0, 0, 1, 0.855], [0, -1, 0, 0.15], [0, 0, 0, 1]]),
0: np.asarray([[0, 0, 1, 0.84],[-1, 0, 0, 1.015], [0, -1, 0, 0.15], [0,0,0,1]])}
